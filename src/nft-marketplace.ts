...
import { ItemBought as ItemBoughtEvent, ItemCanceled as ItemCanceledEvent, ItemListed as ItemListedEvent } from "../generated/NftMarketplace/NftMarketplace";
...
export function handleItemBought(event: ItemBoughtEvent): void {
  ...
  itemBought.save();
  activeItem!.save();
  //save itemBought event

  //ItemBoughtEvent :what we receive in handler Just the Raw event
  //ItemBought Object: what we save object bna ke
}
...
export function handleItemCanceled(event: ItemCanceledEvent): void {
  ...
  //dead address nobody owns ,written dEaD  after 36 0's
